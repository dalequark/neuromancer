...
public class ExperimentController extends WebSocketServer{
  ...
  static String OUTDOOR_PLACES ="./image/outdoor/";
  ...
  public ExperimentController (int participantNum, String outputDir, boolean realFeedback, boolean withEEG, boolean tcpPublish, int trainEpochs, int feedbackEpochs) throws Exception{
...
public void sendToAll( String text ) {
  ...
  private class Dfa implements DfaInt{
  ...
  public static void main(String[] args){
    ...
    try{
      ExperimentController thisExperiment =
        new ExperimentController(participantNum, outputDir, feedback, withEEG, tcpPublish, trainEpochs, feedbackEpochs);
